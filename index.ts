...
class Book extends LibraryItem {
  ...
  getDetails() {
    console.log(
      `The book "${chalk.blueBright(
        this.title
      )}" is written by "${chalk.greenBright(this.author)}."`
    );
  }
}
...
class Magazine extends LibraryItem {
  ...
  getDetails(): void {
    console.log(
      `The Magazine "${chalk.blueBright(
        this.title
      )}" is published by "${chalk.greenBright(this.publisherName)}".`
    );
  }
}
...
class Librarian extends User {
  ...
  feesCollection(amount: number): void {
    console.log(
      `${this.collectorName} as a librarian has collected ${amount} for card payment from user ${this.userName}.`
    );
  }
  ...
  reading(): void {
    console.log(
      ...
      "is reading a librarian-specific book."
    );
  }
}
...
console.log(
  chalk.italic.underline.magentaBright(
